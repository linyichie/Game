...
namespace XLua.CSObjectWrap
{
    ...
    public class WindowControllerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(WindowController);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					WindowController gen_ret = new WindowController();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to WindowController constructor!");
        ...
        static int _m_OpenWindow(RealStatePtr L)
        {
		    try {
                ...
                WindowController gen_to_be_invoked = (WindowController)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to WindowController.OpenWindow!");
