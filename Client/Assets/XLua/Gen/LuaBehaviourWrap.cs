...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaBehaviourWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "StartLuaInjection", _m_StartLuaInjection);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_StartLuaInjection(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.StartLuaInjection( _luaTable );
